    ...
    items.forEach((it, idx) => {
        ...
        itemsHtml += `
            <div style="border-bottom: 1px dashed #ccc; padding: 9px 0;">
                ...
                ${cfg.show_item_name ? `<div style="font-size: ${is58mm ? "12px" : "14px"}; font-weight: bold; line-height: 1.3;">${escapeHtml(name)}${cfg.show_item_qty ? `<span style="margin-left: 14px;">x${qty}</span>` : ""}</div>` : ""}
